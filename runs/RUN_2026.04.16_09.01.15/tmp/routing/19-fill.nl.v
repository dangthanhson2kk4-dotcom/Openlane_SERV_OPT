module serv_synth_wrapper (clk,
 ...
 sky130_fd_sc_hd__buf_4 _0655_ (.A(\rf_ram_if.rtrig0 ),
    .X(_0252_));
 sky130_fd_sc_hd__mux2_1 _0656_ (.A0(net277),
    .A1(net65),
    .S(_0252_),
    .X(_0253_));
 ...
 sky130_fd_sc_hd__or2_1 _0669_ (.A(\cpu.state.gen_csr.misalign_trap_sync_r ),
    .B(_0264_),
    .X(_0265_));
 sky130_fd_sc_hd__clkbuf_4 _0670_ (.A(_0265_),
    .X(_0266_));
 ...
 sky130_fd_sc_hd__clkbuf_1 _0681_ (.A(_0275_),
    .X(net175));
 sky130_fd_sc_hd__clkbuf_4 _0682_ (.A(\rf_ram_if.rtrig0 ),
    .X(_0276_));
 ...
 sky130_fd_sc_hd__or2_1 _0715_ (.A(_0295_),
    .B(_0296_),
    .X(_0297_));
 sky130_fd_sc_hd__buf_2 _0716_ (.A(\cpu.decode.co_mem_word ),
    .X(_0298_));
 ...
 sky130_fd_sc_hd__nand4_1 _0731_ (.A(_0310_),
    ...
    .Y(_0313_));
 sky130_fd_sc_hd__buf_2 _0732_ (.A(_0313_),
    .X(_0314_));
 ...
 sky130_fd_sc_hd__and3_1 _0782_ (.A(\cpu.decode.op21 ),
    ...
    .C(_0262_),
    .X(_0364_));
 sky130_fd_sc_hd__mux2_1 _0783_ (.A0(\rf_ram_if.rdata1 ),
    .A1(net65),
    .S(\rf_ram_if.rtrig1 ),
    .X(_0365_));
 ...
 sky130_fd_sc_hd__and2_1 _0814_ (.A(_0272_),
    .B(_0394_),
    .X(_0395_));
 sky130_fd_sc_hd__a21o_1 _0815_ (.A1(net259),
    .A2(_0266_),
    .B1(_0395_),
    .X(\cpu.o_wdata1 ));
 sky130_fd_sc_hd__a21bo_1 _0816_ (.A1(_0378_),
    ...
    .B1_N(_0379_),
    .X(_0396_));
 sky130_fd_sc_hd__buf_4 _0817_ (.A(_0322_),
    .X(_0397_));
 ...
 sky130_fd_sc_hd__nand2_1 _0849_ (.A(_0417_),
    .B(_0418_),
    .Y(net182));
 sky130_fd_sc_hd__xnor2_2 _0850_ (.A(net173),
    .B(_0417_),
    .Y(net183));
 ...
 sky130_fd_sc_hd__a21oi_1 _0891_ (.A1(_0314_),
    ...
    .B1(_0453_),
    .Y(_0454_));
 sky130_fd_sc_hd__a31o_1 _0892_ (.A1(net207),
    .A2(_0314_),
    .A3(_0452_),
    .B1(_0454_),
    .X(_0010_));
 ...
 sky130_fd_sc_hd__clkbuf_1 _0899_ (.A(_0460_),
    .X(_0011_));
 sky130_fd_sc_hd__o211a_1 _0900_ (.A1(_0435_),
    .A2(_0436_),
    .B1(_0444_),
    .C1(_0452_),
    .X(_0461_));
 ...
 sky130_fd_sc_hd__clkbuf_1 _0928_ (.A(_0482_),
    .X(_0018_));
 sky130_fd_sc_hd__nand4_1 _0929_ (.A(net261),
    .B(_0419_),
 ...
 sky130_fd_sc_hd__o211a_1 _0938_ (.A1(_0267_),
    ...
    .C1(_0489_),
    .X(_0490_));
 sky130_fd_sc_hd__a22o_1 _0939_ (.A1(net251),
    .A2(_0488_),
    .B1(_0490_),
    .B2(_0272_),
    .X(_0021_));
 ...
 sky130_fd_sc_hd__a21oi_1 _0950_ (.A1(_0329_),
    ...
    .B1(_0266_),
    .Y(_0499_));
 sky130_fd_sc_hd__or2b_1 _0951_ (.A(net279),
    .B_N(_0499_),
    .X(_0500_));
 ...
 sky130_fd_sc_hd__and2_1 _0979_ (.A(_0515_),
    .B(net36),
    .X(_0519_));
 sky130_fd_sc_hd__a221o_1 _0980_ (.A1(net268),
    .A2(_0512_),
    .B1(_0514_),
    .B2(\cpu.immdec.gen_immdec_w_eq_1.imm30_25[0] ),
    .C1(_0519_),
    .X(_0033_));
 sky130_fd_sc_hd__buf_2 _0981_ (.A(_0453_),
    .X(_0520_));
 sky130_fd_sc_hd__and2b_1 _0982_ (.A_N(net67),
    .B(_0402_),
    .X(_0521_));
 sky130_fd_sc_hd__buf_2 _0983_ (.A(_0521_),
    .X(_0522_));
 sky130_fd_sc_hd__buf_2 _0984_ (.A(_0522_),
    .X(_0523_));
 ...
 sky130_fd_sc_hd__a22o_1 _0987_ (.A1(net159),
    ...
    .B2(net205),
    .X(_0036_));
 sky130_fd_sc_hd__a22o_1 _0988_ (.A1(net205),
    .A2(_0520_),
    .B1(_0523_),
    .B2(net211),
    .X(_0037_));
 sky130_fd_sc_hd__a22o_1 _0989_ (.A1(net211),
    .A2(_0520_),
    .B1(_0523_),
    .B2(net232),
    .X(_0038_));
 sky130_fd_sc_hd__a22o_1 _0990_ (.A1(net164),
    ...
    .B2(net228),
    .X(_0039_));
 sky130_fd_sc_hd__a22o_1 _0991_ (.A1(net228),
    .A2(_0520_),
    .B1(_0523_),
    .B2(net237),
    .X(_0040_));
 sky130_fd_sc_hd__a22o_1 _0992_ (.A1(net166),
    ...
    .B2(net214),
    .X(_0041_));
 sky130_fd_sc_hd__a22o_1 _0993_ (.A1(net214),
    .A2(_0520_),
    .B1(_0523_),
    .B2(net239),
    .X(_0042_));
 sky130_fd_sc_hd__a22o_1 _0994_ (.A1(net239),
    .A2(_0520_),
    .B1(_0523_),
    .B2(net246),
    .X(_0043_));
 ...
 sky130_fd_sc_hd__a22o_1 _0997_ (.A1(net138),
    ...
    .B2(net234),
    .X(_0044_));
 sky130_fd_sc_hd__a22o_1 _0998_ (.A1(net234),
    .A2(_0524_),
    .B1(_0525_),
    .B2(net255),
    .X(_0045_));
 ...
 sky130_fd_sc_hd__a22o_1 _1000_ (.A1(net141),
    ...
    .B2(net212),
    .X(_0047_));
 sky130_fd_sc_hd__a22o_1 _1001_ (.A1(net212),
    .A2(_0524_),
    .B1(_0525_),
    .B2(net225),
    .X(_0048_));
 sky130_fd_sc_hd__a22o_1 _1002_ (.A1(net225),
    .A2(_0524_),
    .B1(_0525_),
    .B2(net233),
    .X(_0049_));
 sky130_fd_sc_hd__a22o_1 _1003_ (.A1(net233),
    .A2(_0524_),
    .B1(_0525_),
    .B2(net249),
    .X(_0050_));
 sky130_fd_sc_hd__a22o_1 _1004_ (.A1(net249),
    .A2(_0524_),
    .B1(_0525_),
    .B2(net256),
    .X(_0051_));
 sky130_fd_sc_hd__a22o_1 _1005_ (.A1(net146),
    ...
    .B2(net252),
    .X(_0052_));
 sky130_fd_sc_hd__a22o_1 _1006_ (.A1(net252),
    .A2(_0524_),
    .B1(_0525_),
    .B2(net263),
    .X(_0053_));
 ...
 sky130_fd_sc_hd__a22o_1 _1010_ (.A1(net150),
    ...
    .B2(net203),
    .X(_0055_));
 sky130_fd_sc_hd__a22o_1 _1011_ (.A1(net203),
    .A2(_0526_),
    .B1(_0527_),
    .B2(net210),
    .X(_0056_));
 sky130_fd_sc_hd__a22o_1 _1012_ (.A1(net210),
    .A2(_0526_),
    .B1(_0527_),
    .B2(net226),
    .X(_0057_));
 sky130_fd_sc_hd__a22o_1 _1013_ (.A1(net153),
    ...
    .B2(net220),
    .X(_0058_));
 sky130_fd_sc_hd__a22o_1 _1014_ (.A1(net220),
    .A2(_0526_),
    .B1(_0527_),
    .B2(net236),
    .X(_0059_));
 sky130_fd_sc_hd__a22o_1 _1015_ (.A1(net155),
    ...
    .B2(net208),
    .X(_0060_));
 sky130_fd_sc_hd__a22o_1 _1016_ (.A1(net208),
    .A2(_0526_),
    .B1(_0527_),
    .B2(net238),
    .X(_0061_));
 sky130_fd_sc_hd__a22o_1 _1017_ (.A1(net157),
    ...
    .B2(net218),
    .X(_0062_));
 sky130_fd_sc_hd__a22o_1 _1018_ (.A1(net218),
    .A2(_0526_),
    .B1(_0527_),
    .B2(net224),
    .X(_0063_));
 ...
 sky130_fd_sc_hd__a31o_1 _1022_ (.A1(_0268_),
    ...
    .B1(_0529_),
    .X(_0530_));
 sky130_fd_sc_hd__a22o_1 _1023_ (.A1(net222),
    .A2(_0453_),
    .B1(_0522_),
    .B2(_0530_),
    .X(_0065_));
 ...
 sky130_fd_sc_hd__mux2_1 _1089_ (.A0(net117),
    ...
    .S(_0565_),
    .X(_0566_));
 sky130_fd_sc_hd__clkbuf_4 _1090_ (.A(net1),
    .X(_0567_));
 ...
 sky130_fd_sc_hd__o31a_1 _1094_ (.A1(_0311_),
    ...
    .B1(_0570_),
    .X(_0571_));
 sky130_fd_sc_hd__nor2_4 _1095_ (.A(net194),
    .B(_0571_),
    .Y(_0572_));
 ...
 sky130_fd_sc_hd__a21bo_1 _1110_ (.A1(_0579_),
    ...
    .B1_N(_0574_),
    .X(_0585_));
 sky130_fd_sc_hd__o22a_1 _1111_ (.A1(net264),
    .A2(_0574_),
    .B1(_0584_),
    .B2(_0585_),
    .X(_0098_));
 ...
 sky130_fd_sc_hd__nor2_1 _1175_ (.A(net193),
    .B(_0627_),
    .Y(_0632_));
 sky130_fd_sc_hd__a21o_1 _1176_ (.A1(net278),
    .A2(net193),
    .B1(_0420_),
    .X(_0633_));
 ...
 sky130_fd_sc_hd__a21bo_1 _1198_ (.A1(_0420_),
    ...
    .B1_N(_0636_),
    .X(_0649_));
 sky130_fd_sc_hd__o22a_1 _1199_ (.A1(net227),
    .A2(_0636_),
    .B1(_0648_),
    .B2(_0649_),
    .X(_0122_));
 ...
 sky130_fd_sc_hd__nor2_1 _1202_ (.A(_0515_),
    .B(_0650_),
    .Y(_0652_));
 sky130_fd_sc_hd__a221o_1 _1203_ (.A1(net270),
    .A2(_0651_),
    .B1(_0652_),
    .B2(net271),
    .C1(_0606_),
 ...
 sky130_fd_sc_hd__and2_1 _1204_ (.A(_0419_),
    .B(net46),
    .X(_0175_));
 sky130_fd_sc_hd__a221o_1 _1205_ (.A1(net266),
    .A2(_0651_),
    .B1(_0652_),
    .B2(net270),
    .C1(_0175_),
 ...
 sky130_fd_sc_hd__clkbuf_1 _1315_ (.A(_0243_),
    .X(_0166_));
 sky130_fd_sc_hd__o21a_1 _1316_ (.A1(net262),
    .A2(_0437_),
    .B1(_0452_),
    .X(_0167_));
 ...
 sky130_fd_sc_hd__clkbuf_1 _1326_ (.A(_0248_),
    .X(_0172_));
 sky130_fd_sc_hd__nand2_1 _1327_ (.A(net248),
    .B(_0314_),
    .Y(_0249_));
 ...
 sky130_fd_sc_hd__o21ba_1 _1331_ (.A1(_0250_),
    ...
    .B1_N(_0415_),
    .X(_0174_));
 sky130_fd_sc_hd__dfxtp_1 _1332_ (.CLK(clk),
    .D(_0005_),
    .Q(\rf_ram_if.rreq_r ));
 sky130_fd_sc_hd__dfxtp_1 _1333_ (.CLK(clk),
    .D(net199),
    .Q(\rf_ram_if.wdata1_r[0] ));
 sky130_fd_sc_hd__dfxtp_1 _1334_ (.CLK(clk),
    .D(net198),
    .Q(\rf_ram_if.wdata1_r[1] ));
 sky130_fd_sc_hd__dfxtp_1 _1335_ (.CLK(clk),
    .D(\cpu.o_wdata1 ),
    .Q(\rf_ram_if.wdata1_r[2] ));
 sky130_fd_sc_hd__dfxtp_1 _1336_ (.CLK(clk),
    .D(net200),
    .Q(\rf_ram_if.wdata0_r[0] ));
 sky130_fd_sc_hd__dfxtp_1 _1337_ (.CLK(clk),
    .D(\cpu.o_wdata0 ),
 ...
 sky130_fd_sc_hd__dfxtp_1 _1340_ (.CLK(clk),
    .D(net201),
    .Q(\rf_ram_if.rtrig1 ));
 sky130_fd_sc_hd__dfxtp_1 _1341_ (.CLK(clk),
    .D(_0008_),
    .Q(\rf_ram_if.rgnt ));
 sky130_fd_sc_hd__dfxtp_1 _1342_ (.CLK(clk),
    .D(_0009_),
    .Q(\rf_ram_if.rdata1 ));
 sky130_fd_sc_hd__dfxtp_1 _1343_ (.CLK(clk),
    .D(_0010_),
    .Q(\cpu.state.ibus_cyc ));
 sky130_fd_sc_hd__dfxtp_1 _1344_ (.CLK(clk),
    .D(_0011_),
    .Q(\rf_ram_if.wen0_r ));
 ...
 sky130_fd_sc_hd__dfxtp_2 _1346_ (.CLK(clk),
    .D(_0012_),
    .Q(\rf_ram_if.rtrig0 ));
 sky130_fd_sc_hd__dfxtp_1 _1347_ (.CLK(clk),
    .D(_0013_),
    .Q(net171));
 sky130_fd_sc_hd__dfxtp_1 _1348_ (.CLK(clk),
    .D(_0014_),
    .Q(net172));
 ...
 sky130_fd_sc_hd__dfxtp_2 _1351_ (.CLK(clk),
    .D(_0017_),
    .Q(\cpu.bufreg.data[1] ));
 sky130_fd_sc_hd__dfxtp_1 _1352_ (.CLK(clk),
    .D(_0018_),
    .Q(\rf_ram_if.wen1_r ));
 sky130_fd_sc_hd__dfxtp_2 _1353_ (.CLK(clk),
    .D(_0019_),
    .Q(\cpu.gen_csr.csr.o_new_irq ));
 sky130_fd_sc_hd__dfxtp_1 _1354_ (.CLK(clk),
    .D(_0020_),
    .Q(\cpu.bufreg.i_sh_signed ));
 sky130_fd_sc_hd__dfxtp_1 _1355_ (.CLK(clk),
    .D(_0021_),
    .Q(\cpu.gen_csr.csr.mstatus_mie ));
 sky130_fd_sc_hd__dfxtp_1 _1356_ (.CLK(clk),
    .D(_0022_),
    .Q(\cpu.gen_csr.csr.mie_mtie ));
 sky130_fd_sc_hd__dfxtp_1 _1357_ (.CLK(clk),
    .D(_0023_),
    .Q(\cpu.gen_csr.csr.mstatus_mpie ));
 sky130_fd_sc_hd__dfxtp_1 _1358_ (.CLK(clk),
    .D(_0024_),
    .Q(\cpu.gen_csr.csr.mcause31 ));
 sky130_fd_sc_hd__dfxtp_1 _1359_ (.CLK(clk),
    .D(_0025_),
    .Q(\cpu.gen_csr.csr.mcause3_0[0] ));
 sky130_fd_sc_hd__dfxtp_1 _1360_ (.CLK(clk),
    .D(_0026_),
    .Q(\cpu.gen_csr.csr.mcause3_0[1] ));
 sky130_fd_sc_hd__dfxtp_1 _1361_ (.CLK(clk),
    .D(_0027_),
    .Q(\cpu.gen_csr.csr.mcause3_0[2] ));
 sky130_fd_sc_hd__dfxtp_1 _1362_ (.CLK(clk),
    .D(_0028_),
    .Q(\cpu.gen_csr.csr.mcause3_0[3] ));
 sky130_fd_sc_hd__dfxtp_1 _1363_ (.CLK(clk),
    .D(_0029_),
    .Q(\cpu.immdec.gen_immdec_w_eq_1.imm11_7[0] ));
 sky130_fd_sc_hd__dfxtp_1 _1364_ (.CLK(clk),
    .D(_0030_),
    .Q(\cpu.immdec.gen_immdec_w_eq_1.imm11_7[1] ));
 sky130_fd_sc_hd__dfxtp_1 _1365_ (.CLK(clk),
    .D(net273),
    .Q(\cpu.immdec.gen_immdec_w_eq_1.imm11_7[2] ));
 sky130_fd_sc_hd__dfxtp_1 _1366_ (.CLK(clk),
    .D(net269),
    .Q(\cpu.immdec.gen_immdec_w_eq_1.imm11_7[3] ));
 sky130_fd_sc_hd__dfxtp_1 _1367_ (.CLK(clk),
    .D(_0033_),
    .Q(\cpu.immdec.gen_immdec_w_eq_1.imm11_7[4] ));
 sky130_fd_sc_hd__dfxtp_1 _1368_ (.CLK(clk),
    .D(_0001_),
    .Q(\cpu.alu.add_cy_r ));
 ...
 sky130_fd_sc_hd__dfxtp_2 _1371_ (.CLK(clk),
    .D(net206),
    .Q(net159));
 sky130_fd_sc_hd__dfxtp_1 _1372_ (.CLK(clk),
    .D(_0037_),
    .Q(net162));
 sky130_fd_sc_hd__dfxtp_1 _1373_ (.CLK(clk),
    .D(_0038_),
    .Q(net163));
 ...
 sky130_fd_sc_hd__dfxtp_2 _1432_ (.CLK(clk),
    .D(_0095_),
    .Q(net91));
 sky130_fd_sc_hd__dfxtp_4 _1433_ (.CLK(clk),
    .D(_0096_),
    .Q(net116));
 ...
 sky130_fd_sc_hd__dfxtp_1 _1453_ (.CLK(clk),
    .D(_0115_),
 ...
 sky130_fd_sc_hd__dfxtp_1 _1457_ (.CLK(clk),
    .D(_0119_),
 ...
 sky130_fd_sc_hd__dfxtp_1 _1465_ (.CLK(clk),
    .D(_0127_),
    .Q(\cpu.immdec.gen_immdec_w_eq_1.imm24_20[4] ));
 sky130_fd_sc_hd__dfxtp_1 _1466_ (.CLK(clk),
    .D(_0128_),
    .Q(\cpu.decode.op26 ));
 sky130_fd_sc_hd__dfxtp_1 _1467_ (.CLK(clk),
    .D(_0129_),
    .Q(\cpu.decode.op22 ));
 sky130_fd_sc_hd__dfxtp_1 _1468_ (.CLK(clk),
    .D(_0130_),
    .Q(\cpu.decode.op21 ));
 ...
 sky130_fd_sc_hd__dfxtp_2 _1470_ (.CLK(clk),
    .D(_0132_),
    .Q(\cpu.bne_or_bge ));
 sky130_fd_sc_hd__dfxtp_1 _1471_ (.CLK(clk),
    .D(_0133_),
    .Q(\cpu.decode.co_mem_word ));
 sky130_fd_sc_hd__dfxtp_1 _1472_ (.CLK(clk),
    .D(_0134_),
    .Q(\cpu.bufreg.i_right_shift_op ));
 sky130_fd_sc_hd__dfxtp_1 _1473_ (.CLK(clk),
    .D(_0135_),
 ...
 sky130_fd_sc_hd__dfxtp_4 _1476_ (.CLK(clk),
    .D(_0138_),
    .Q(net136));
 sky130_fd_sc_hd__dfxtp_2 _1477_ (.CLK(clk),
    .D(_0139_),
    .Q(\cpu.branch_op ));
 sky130_fd_sc_hd__dfxtp_1 _1478_ (.CLK(clk),
    .D(_0140_),
    .Q(net100));
 sky130_fd_sc_hd__dfxtp_1 _1479_ (.CLK(clk),
    .D(_0141_),
    .Q(net111));
 sky130_fd_sc_hd__dfxtp_2 _1480_ (.CLK(clk),
    .D(_0142_),
    .Q(net122));
 sky130_fd_sc_hd__dfxtp_1 _1481_ (.CLK(clk),
    .D(_0143_),
    .Q(net125));
 sky130_fd_sc_hd__dfxtp_1 _1482_ (.CLK(clk),
    .D(_0144_),
    .Q(net126));
 sky130_fd_sc_hd__dfxtp_1 _1483_ (.CLK(clk),
    .D(_0145_),
    .Q(net127));
 sky130_fd_sc_hd__dfxtp_1 _1484_ (.CLK(clk),
    .D(_0146_),
    .Q(net128));
 sky130_fd_sc_hd__dfxtp_1 _1485_ (.CLK(clk),
    .D(_0147_),
    .Q(net129));
 sky130_fd_sc_hd__dfxtp_1 _1486_ (.CLK(clk),
    .D(_0148_),
    .Q(net130));
 sky130_fd_sc_hd__dfxtp_1 _1487_ (.CLK(clk),
    .D(_0149_),
    .Q(net131));
 sky130_fd_sc_hd__dfxtp_1 _1488_ (.CLK(clk),
    .D(_0150_),
    .Q(net101));
 sky130_fd_sc_hd__dfxtp_1 _1489_ (.CLK(clk),
    .D(_0151_),
    .Q(net102));
 sky130_fd_sc_hd__dfxtp_1 _1490_ (.CLK(clk),
    .D(_0152_),
    .Q(net103));
 sky130_fd_sc_hd__dfxtp_1 _1491_ (.CLK(clk),
    .D(_0153_),
    .Q(net104));
 sky130_fd_sc_hd__dfxtp_1 _1492_ (.CLK(clk),
    .D(_0154_),
    .Q(net105));
 sky130_fd_sc_hd__dfxtp_1 _1493_ (.CLK(clk),
    .D(_0155_),
    .Q(net106));
 sky130_fd_sc_hd__dfxtp_1 _1494_ (.CLK(clk),
    .D(_0156_),
    .Q(net107));
 sky130_fd_sc_hd__dfxtp_1 _1495_ (.CLK(clk),
    .D(_0157_),
    .Q(net108));
 sky130_fd_sc_hd__dfxtp_1 _1496_ (.CLK(clk),
    .D(_0158_),
    .Q(net109));
 sky130_fd_sc_hd__dfxtp_1 _1497_ (.CLK(clk),
    .D(_0159_),
    .Q(net110));
 sky130_fd_sc_hd__dfxtp_2 _1498_ (.CLK(clk),
    .D(_0160_),
    .Q(net112));
 sky130_fd_sc_hd__dfxtp_1 _1499_ (.CLK(clk),
    .D(_0161_),
    .Q(net113));
 sky130_fd_sc_hd__dfxtp_1 _1500_ (.CLK(clk),
    .D(_0162_),
    .Q(net114));
 sky130_fd_sc_hd__dfxtp_1 _1501_ (.CLK(clk),
    .D(_0163_),
    .Q(net115));
 sky130_fd_sc_hd__dfxtp_1 _1502_ (.CLK(clk),
    .D(_0164_),
    .Q(\cpu.state.o_cnt[2] ));
 sky130_fd_sc_hd__dfxtp_1 _1503_ (.CLK(clk),
    .D(_0165_),
    .Q(\cpu.bufreg2.i_bytecnt[0] ));
 sky130_fd_sc_hd__dfxtp_1 _1504_ (.CLK(clk),
    .D(_0166_),
    .Q(\cpu.bufreg2.i_bytecnt[1] ));
 sky130_fd_sc_hd__dfxtp_1 _1505_ (.CLK(clk),
    .D(_0167_),
    .Q(\cpu.state.gen_csr.misalign_trap_sync_r ));
 sky130_fd_sc_hd__dfxtp_1 _1506_ (.CLK(clk),
    .D(_0168_),
    .Q(\cpu.mem_if.signbit ));
 sky130_fd_sc_hd__dfxtp_1 _1507_ (.CLK(clk),
    .D(_0169_),
    .Q(\cpu.state.cnt_r[0] ));
 sky130_fd_sc_hd__dfxtp_1 _1508_ (.CLK(clk),
    .D(_0170_),
    .Q(\cpu.state.cnt_r[1] ));
 sky130_fd_sc_hd__dfxtp_1 _1509_ (.CLK(clk),
    .D(_0171_),
    .Q(\cpu.state.cnt_r[2] ));
 sky130_fd_sc_hd__dfxtp_1 _1510_ (.CLK(clk),
    .D(_0172_),
    .Q(\cpu.state.cnt_r[3] ));
 sky130_fd_sc_hd__dfxtp_1 _1511_ (.CLK(clk),
    .D(_0173_),
    .Q(\cpu.state.init_done ));
 sky130_fd_sc_hd__dfxtp_1 _1512_ (.CLK(clk),
    .D(_0174_),
    .Q(\cpu.ctrl.i_jump ));
 sky130_fd_sc_hd__conb_1 serv_synth_wrapper_197 (.LO(net197));
 ...
 sky130_fd_sc_hd__buf_1 input2 (.A(i_dbus_rdt[0]),
    .X(net2));
 sky130_fd_sc_hd__buf_1 input3 (.A(i_dbus_rdt[10]),
    .X(net3));
 ...
 sky130_fd_sc_hd__clkbuf_1 input7 (.A(i_dbus_rdt[14]),
    .X(net7));
 sky130_fd_sc_hd__clkbuf_1 input8 (.A(i_dbus_rdt[15]),
    .X(net8));
 ...
 sky130_fd_sc_hd__clkbuf_1 input17 (.A(i_dbus_rdt[23]),
    .X(net17));
 sky130_fd_sc_hd__buf_1 input18 (.A(i_dbus_rdt[24]),
    .X(net18));
 sky130_fd_sc_hd__buf_1 input19 (.A(i_dbus_rdt[25]),
    .X(net19));
 sky130_fd_sc_hd__clkbuf_1 input20 (.A(i_dbus_rdt[26]),
    .X(net20));
 sky130_fd_sc_hd__dlymetal6s2s_1 input21 (.A(i_dbus_rdt[27]),
    .X(net21));
 sky130_fd_sc_hd__clkbuf_2 input22 (.A(i_dbus_rdt[28]),
    .X(net22));
 sky130_fd_sc_hd__clkbuf_1 input23 (.A(i_dbus_rdt[29]),
    .X(net23));
 sky130_fd_sc_hd__clkbuf_1 input24 (.A(i_dbus_rdt[2]),
    .X(net24));
 sky130_fd_sc_hd__clkbuf_1 input25 (.A(i_dbus_rdt[30]),
    .X(net25));
 sky130_fd_sc_hd__buf_1 input26 (.A(i_dbus_rdt[31]),
    .X(net26));
 sky130_fd_sc_hd__clkbuf_1 input27 (.A(i_dbus_rdt[3]),
    .X(net27));
 ...
 sky130_fd_sc_hd__clkbuf_1 input31 (.A(i_dbus_rdt[7]),
    .X(net31));
 sky130_fd_sc_hd__clkbuf_1 input32 (.A(i_dbus_rdt[8]),
    .X(net32));
 ...
 sky130_fd_sc_hd__clkbuf_1 input36 (.A(i_ibus_rdt[11]),
    .X(net36));
 sky130_fd_sc_hd__dlymetal6s2s_1 input37 (.A(i_ibus_rdt[12]),
    .X(net37));
 sky130_fd_sc_hd__buf_1 input38 (.A(i_ibus_rdt[13]),
    .X(net38));
 sky130_fd_sc_hd__buf_1 input39 (.A(i_ibus_rdt[14]),
    .X(net39));
 sky130_fd_sc_hd__clkbuf_1 input40 (.A(i_ibus_rdt[15]),
    .X(net40));
 ...
 sky130_fd_sc_hd__buf_2 output192 (.A(net192),
    .X(o_wen));
 sky130_fd_sc_hd__clkbuf_2 max_cap193 (.A(net194),
    .X(net193));
 sky130_fd_sc_hd__clkbuf_2 wire194 (.A(_0411_),
    .X(net194));
 sky130_fd_sc_hd__clkbuf_2 max_cap195 (.A(_0337_),
    .X(net195));
 sky130_fd_sc_hd__conb_1 serv_synth_wrapper_196 (.LO(net196));
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold4 (.A(\rf_ram_if.rtrig0 ),
    .X(net201));
 sky130_fd_sc_hd__dlygate4sd3_1 hold5 (.A(\rf_ram_if.rgnt ),
    .X(net202));
 sky130_fd_sc_hd__dlygate4sd3_1 hold6 (.A(net151),
    .X(net203));
 sky130_fd_sc_hd__dlygate4sd3_1 hold7 (.A(_0055_),
    .X(net204));
 sky130_fd_sc_hd__dlygate4sd3_1 hold8 (.A(net162),
    .X(net205));
 sky130_fd_sc_hd__dlygate4sd3_1 hold9 (.A(_0036_),
    .X(net206));
 sky130_fd_sc_hd__dlygate4sd3_1 hold10 (.A(\cpu.state.ibus_cyc ),
    .X(net207));
 sky130_fd_sc_hd__dlygate4sd3_1 hold11 (.A(net156),
    .X(net208));
 sky130_fd_sc_hd__dlygate4sd3_1 hold12 (.A(_0060_),
    .X(net209));
 sky130_fd_sc_hd__dlygate4sd3_1 hold13 (.A(net152),
    .X(net210));
 sky130_fd_sc_hd__dlygate4sd3_1 hold14 (.A(net163),
    .X(net211));
 sky130_fd_sc_hd__dlygate4sd3_1 hold15 (.A(net142),
    .X(net212));
 sky130_fd_sc_hd__dlygate4sd3_1 hold16 (.A(_0047_),
    .X(net213));
 sky130_fd_sc_hd__dlygate4sd3_1 hold17 (.A(net167),
    .X(net214));
 sky130_fd_sc_hd__dlygate4sd3_1 hold18 (.A(_0041_),
    .X(net215));
 sky130_fd_sc_hd__dlygate4sd3_1 hold19 (.A(\cpu.gen_csr.csr.timer_irq_r ),
    .X(net216));
 sky130_fd_sc_hd__dlygate4sd3_1 hold20 (.A(_0105_),
    .X(net217));
 sky130_fd_sc_hd__dlygate4sd3_1 hold21 (.A(net158),
    .X(net218));
 sky130_fd_sc_hd__dlygate4sd3_1 hold22 (.A(_0062_),
    .X(net219));
 sky130_fd_sc_hd__dlygate4sd3_1 hold23 (.A(net154),
    .X(net220));
 sky130_fd_sc_hd__dlygate4sd3_1 hold24 (.A(_0058_),
    .X(net221));
 sky130_fd_sc_hd__dlygate4sd3_1 hold25 (.A(net161),
    .X(net222));
 sky130_fd_sc_hd__dlygate4sd3_1 hold26 (.A(_0064_),
    .X(net223));
 sky130_fd_sc_hd__dlygate4sd3_1 hold27 (.A(net160),
    .X(net224));
 sky130_fd_sc_hd__dlygate4sd3_1 hold28 (.A(net143),
    .X(net225));
 sky130_fd_sc_hd__dlygate4sd3_1 hold29 (.A(net153),
    .X(net226));
 sky130_fd_sc_hd__dlygate4sd3_1 hold30 (.A(\cpu.immdec.gen_immdec_w_eq_1.imm30_25[5] ),
    .X(net227));
 sky130_fd_sc_hd__dlygate4sd3_1 hold31 (.A(net165),
    .X(net228));
 sky130_fd_sc_hd__dlygate4sd3_1 hold32 (.A(_0039_),
    .X(net229));
 sky130_fd_sc_hd__dlygate4sd3_1 hold33 (.A(net159),
    .X(net230));
 sky130_fd_sc_hd__dlygate4sd3_1 hold34 (.A(_0035_),
    .X(net231));
 sky130_fd_sc_hd__dlygate4sd3_1 hold35 (.A(net164),
    .X(net232));
 sky130_fd_sc_hd__dlygate4sd3_1 hold36 (.A(net144),
    .X(net233));
 sky130_fd_sc_hd__dlygate4sd3_1 hold37 (.A(net139),
    .X(net234));
 sky130_fd_sc_hd__dlygate4sd3_1 hold38 (.A(_0044_),
    .X(net235));
 sky130_fd_sc_hd__dlygate4sd3_1 hold39 (.A(net155),
    .X(net236));
 sky130_fd_sc_hd__dlygate4sd3_1 hold40 (.A(net166),
    .X(net237));
 sky130_fd_sc_hd__dlygate4sd3_1 hold41 (.A(net157),
    .X(net238));
 sky130_fd_sc_hd__dlygate4sd3_1 hold42 (.A(net168),
    .X(net239));
 sky130_fd_sc_hd__dlygate4sd3_1 hold43 (.A(net148),
    .X(net240));
 sky130_fd_sc_hd__dlygate4sd3_1 hold44 (.A(_0034_),
    .X(net241));
 sky130_fd_sc_hd__dlygate4sd3_1 hold45 (.A(net141),
    .X(net242));
 sky130_fd_sc_hd__dlygate4sd3_1 hold46 (.A(_0046_),
    .X(net243));
 sky130_fd_sc_hd__dlygate4sd3_1 hold47 (.A(net150),
    .X(net244));
 sky130_fd_sc_hd__dlygate4sd3_1 hold48 (.A(_0054_),
    .X(net245));
 sky130_fd_sc_hd__dlygate4sd3_1 hold49 (.A(net138),
    .X(net246));
 sky130_fd_sc_hd__dlygate4sd3_1 hold50 (.A(\cpu.immdec.gen_immdec_w_eq_1.imm30_25[4] ),
    .X(net247));
 sky130_fd_sc_hd__dlygate4sd3_1 hold51 (.A(\cpu.state.init_done ),
    .X(net248));
 sky130_fd_sc_hd__dlygate4sd3_1 hold52 (.A(net145),
    .X(net249));
 sky130_fd_sc_hd__dlygate4sd3_1 hold53 (.A(\cpu.decode.op21 ),
    .X(net250));
 sky130_fd_sc_hd__dlygate4sd3_1 hold54 (.A(\cpu.gen_csr.csr.mstatus_mie ),
    .X(net251));
 sky130_fd_sc_hd__dlygate4sd3_1 hold55 (.A(net147),
    .X(net252));
 sky130_fd_sc_hd__dlygate4sd3_1 hold56 (.A(_0052_),
    .X(net253));
 sky130_fd_sc_hd__dlygate4sd3_1 hold57 (.A(\cpu.decode.co_ebreak ),
    .X(net254));
 sky130_fd_sc_hd__dlygate4sd3_1 hold58 (.A(net140),
    .X(net255));
 sky130_fd_sc_hd__dlygate4sd3_1 hold59 (.A(net146),
    .X(net256));
 sky130_fd_sc_hd__dlygate4sd3_1 hold60 (.A(\cpu.decode.op22 ),
    .X(net257));
 sky130_fd_sc_hd__dlygate4sd3_1 hold61 (.A(\cpu.mem_if.signbit ),
    .X(net258));
 sky130_fd_sc_hd__dlygate4sd3_1 hold62 (.A(net137),
    .X(net259));
 sky130_fd_sc_hd__dlygate4sd3_1 hold63 (.A(\rf_ram_if.rreq_r ),
    .X(net260));
 sky130_fd_sc_hd__dlygate4sd3_1 hold64 (.A(\cpu.gen_csr.csr.mie_mtie ),
    .X(net261));
 sky130_fd_sc_hd__dlygate4sd3_1 hold65 (.A(\cpu.state.gen_csr.misalign_trap_sync_r ),
    .X(net262));
 sky130_fd_sc_hd__dlygate4sd3_1 hold66 (.A(net149),
    .X(net263));
 sky130_fd_sc_hd__dlygate4sd3_1 hold67 (.A(net118),
    .X(net264));
 sky130_fd_sc_hd__dlygate4sd3_1 hold68 (.A(\cpu.immdec.gen_immdec_w_eq_1.imm24_20[4] ),
    .X(net265));
 sky130_fd_sc_hd__dlygate4sd3_1 hold69 (.A(\cpu.immdec.gen_immdec_w_eq_1.imm24_20[2] ),
    .X(net266));
 sky130_fd_sc_hd__dlygate4sd3_1 hold70 (.A(_0125_),
    .X(net267));
 sky130_fd_sc_hd__dlygate4sd3_1 hold71 (.A(\cpu.immdec.gen_immdec_w_eq_1.imm11_7[4] ),
    .X(net268));
 sky130_fd_sc_hd__dlygate4sd3_1 hold72 (.A(_0032_),
    .X(net269));
 sky130_fd_sc_hd__dlygate4sd3_1 hold73 (.A(\cpu.immdec.gen_immdec_w_eq_1.imm24_20[1] ),
    .X(net270));
 sky130_fd_sc_hd__dlygate4sd3_1 hold74 (.A(\cpu.immdec.gen_immdec_w_eq_1.imm24_20[0] ),
    .X(net271));
 sky130_fd_sc_hd__dlygate4sd3_1 hold75 (.A(\cpu.immdec.gen_immdec_w_eq_1.imm11_7[3] ),
    .X(net272));
 sky130_fd_sc_hd__dlygate4sd3_1 hold76 (.A(_0031_),
    .X(net273));
 sky130_fd_sc_hd__dlygate4sd3_1 hold77 (.A(\cpu.state.cnt_r[2] ),
    .X(net274));
 sky130_fd_sc_hd__dlygate4sd3_1 hold78 (.A(\cpu.immdec.gen_immdec_w_eq_1.imm11_7[2] ),
    .X(net275));
 sky130_fd_sc_hd__dlygate4sd3_1 hold79 (.A(\cpu.state.cnt_r[1] ),
    .X(net276));
 sky130_fd_sc_hd__dlygate4sd3_1 hold80 (.A(\rf_ram_if.rdata0[1] ),
    .X(net277));
 sky130_fd_sc_hd__dlygate4sd3_1 hold81 (.A(\cpu.immdec.gen_immdec_w_eq_1.imm7 ),
    .X(net278));
 sky130_fd_sc_hd__dlygate4sd3_1 hold82 (.A(\cpu.gen_csr.csr.mcause31 ),
    .X(net279));
 ...
 sky130_fd_sc_hd__decap_8 FILLER_0_2_90 ();
 sky130_fd_sc_hd__fill_1 FILLER_0_2_98 ();
 sky130_fd_sc_hd__decap_4 FILLER_0_2_102 ();
 sky130_fd_sc_hd__decap_3 FILLER_0_2_125 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_0_2_287 ();
 ...
 sky130_fd_sc_hd__decap_3 FILLER_0_3_123 ();
 sky130_fd_sc_hd__fill_1 FILLER_0_3_167 ();
 sky130_fd_sc_hd__decap_3 FILLER_0_3_169 ();
 sky130_fd_sc_hd__decap_8 FILLER_0_3_175 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_0_3_290 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_0_4_226 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_0_8_272 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_0_9_38 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_0_10_179 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_0_11_21 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_0_11_127 ();
 ...
 sky130_fd_sc_hd__decap_3 FILLER_0_13_41 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_0_13_202 ();
 ...
 sky130_fd_sc_hd__decap_4 FILLER_0_13_310 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_0_14_159 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_0_15_13 ();
 ...
 sky130_fd_sc_hd__decap_4 FILLER_0_15_103 ();
 ...
 sky130_fd_sc_hd__decap_4 FILLER_0_18_37 ();
 sky130_fd_sc_hd__fill_1 FILLER_0_18_41 ();
 sky130_fd_sc_hd__decap_6 FILLER_0_18_58 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_0_18_158 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_0_19_22 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_0_19_173 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_0_20_59 ();
 ...
 sky130_fd_sc_hd__decap_4 FILLER_0_21_99 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_0_24_55 ();
 ...
 sky130_fd_sc_hd__decap_4 FILLER_0_24_201 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_0_24_294 ();
 ...
 sky130_fd_sc_hd__fill_2 FILLER_0_26_182 ();
 ...
 sky130_fd_sc_hd__fill_2 FILLER_0_26_271 ();
 ...
 sky130_fd_sc_hd__decap_4 FILLER_0_27_156 ();
 ...
 sky130_fd_sc_hd__decap_4 FILLER_0_29_191 ();
 ...
 sky130_fd_sc_hd__fill_1 FILLER_0_31_22 ();
 ...
 sky130_fd_sc_hd__fill_1 FILLER_0_33_30 ();
 ...
 sky130_fd_sc_hd__decap_3 FILLER_0_33_156 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_0_33_256 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_0_34_147 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_0_34_226 ();
 ...
 sky130_fd_sc_hd__decap_3 FILLER_0_34_266 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_0_35_257 ();
 sky130_fd_sc_hd__fill_1 FILLER_0_35_263 ();
 sky130_fd_sc_hd__decap_6 FILLER_0_35_271 ();
 ...
 sky130_fd_sc_hd__fill_2 FILLER_0_36_131 ();
 ...
 sky130_fd_sc_hd__decap_4 FILLER_0_37_235 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_0_38_38 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_0_39_78 ();
 ...
 sky130_fd_sc_hd__fill_1 FILLER_0_39_268 ();
 ...
 sky130_fd_sc_hd__decap_4 FILLER_0_40_32 ();
 sky130_fd_sc_hd__decap_6 FILLER_0_40_44 ();
 sky130_fd_sc_hd__fill_1 FILLER_0_40_66 ();
 ...
 sky130_fd_sc_hd__decap_4 FILLER_0_41_77 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_0_42_162 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_0_43_35 ();
 ...
 sky130_fd_sc_hd__decap_3 FILLER_0_44_266 ();
 ...
 sky130_fd_sc_hd__decap_3 FILLER_0_45_41 ();
 sky130_ef_sc_hd__decap_12 FILLER_0_45_73 ();
 sky130_fd_sc_hd__decap_6 FILLER_0_45_85 ();
 sky130_fd_sc_hd__fill_1 FILLER_0_45_91 ();
 sky130_fd_sc_hd__decap_4 FILLER_0_45_108 ();
 sky130_fd_sc_hd__decap_4 FILLER_0_45_121 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_0_45_182 ();
 ...
 sky130_fd_sc_hd__fill_2 FILLER_0_46_107 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_0_48_258 ();
 sky130_fd_sc_hd__fill_1 FILLER_0_48_264 ();
 ...
 sky130_fd_sc_hd__decap_4 FILLER_0_49_40 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_0_49_208 ();
 ...
 sky130_fd_sc_hd__fill_2 FILLER_0_49_303 ();
 ...
 sky130_fd_sc_hd__decap_3 FILLER_0_51_268 ();
 ...
 assign o_dbus_adr[0] = net196;
 assign o_dbus_adr[1] = net197;
endmodule
