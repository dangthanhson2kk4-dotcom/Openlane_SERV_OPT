module serv_synth_wrapper (clk,
 ...
 sky130_fd_sc_hd__nor2_1 _0654_ (.A(\cpu.bufreg.data[1] ),
    .B(\cpu.bufreg.data[0] ),
    .Y(net132));
 sky130_fd_sc_hd__clkbuf_4 _0655_ (.A(\rf_ram_if.rtrig0 ),
    .X(_0252_));
 ...
 sky130_fd_sc_hd__or2_1 _0661_ (.A(\cpu.bne_or_bge ),
    ...
    .X(_0257_));
 sky130_fd_sc_hd__nor2_1 _0662_ (.A(\cpu.bufreg.i_right_shift_op ),
    .B(_0257_),
    .Y(_0258_));
 ...
 sky130_fd_sc_hd__and2b_1 _0666_ (.A_N(_0258_),
    .B(_0261_),
    .X(_0262_));
 sky130_fd_sc_hd__o21a_1 _0667_ (.A1(\cpu.decode.co_ebreak ),
    .A2(_0255_),
    .B1(_0262_),
    .X(_0263_));
 ...
 sky130_fd_sc_hd__and3_1 _0671_ (.A(\cpu.decode.op21 ),
    ...
    .C(_0261_),
    .X(_0267_));
 sky130_fd_sc_hd__or2_1 _0672_ (.A(_0266_),
    .B(_0267_),
    .X(_0268_));
 ...
 sky130_fd_sc_hd__clkbuf_1 _0705_ (.A(_0287_),
    .X(net191));
 sky130_fd_sc_hd__buf_2 _0706_ (.A(\cpu.branch_op ),
    .X(_0288_));
 sky130_fd_sc_hd__buf_2 _0707_ (.A(\cpu.decode.opcode[0] ),
    .X(_0289_));
 sky130_fd_sc_hd__buf_2 _0708_ (.A(_0259_),
    .X(_0290_));
 ...
 sky130_fd_sc_hd__nor2_1 _0717_ (.A(_0260_),
    .B(_0298_),
    .Y(_0299_));
 sky130_fd_sc_hd__buf_2 _0718_ (.A(\cpu.bufreg.i_right_shift_op ),
    .X(_0300_));
 ...
 sky130_fd_sc_hd__inv_2 _0727_ (.A(\cpu.bufreg.i_right_shift_op ),
    .Y(_0309_));
 sky130_fd_sc_hd__buf_2 _0728_ (.A(\cpu.state.cnt_r[3] ),
    .X(_0310_));
 sky130_fd_sc_hd__clkbuf_4 _0729_ (.A(\cpu.bufreg2.i_bytecnt[1] ),
    .X(_0311_));
 sky130_fd_sc_hd__buf_2 _0730_ (.A(\cpu.state.o_cnt[2] ),
    .X(_0312_));
 ...
 sky130_fd_sc_hd__and2_1 _0754_ (.A(_0297_),
    .B(_0335_),
    .X(_0336_));
 sky130_fd_sc_hd__nor3_1 _0755_ (.A(_0311_),
    .B(_0312_),
 ...
 sky130_fd_sc_hd__a31o_1 _0787_ (.A1(_0307_),
    ...
    .B1(_0368_),
    .X(_0369_));
 sky130_fd_sc_hd__a211o_1 _0788_ (.A1(_0313_),
    .A2(_0328_),
    .B1(_0330_),
    .C1(net136),
    .X(_0370_));
 ...
 sky130_fd_sc_hd__a22o_1 _0805_ (.A1(\cpu.bufreg.data[0] ),
    ...
    .B2(_0258_),
    .X(_0387_));
 sky130_fd_sc_hd__buf_2 _0806_ (.A(\cpu.decode.opcode[2] ),
    .X(_0388_));
 ...
 sky130_fd_sc_hd__inv_2 _0823_ (.A(\cpu.bufreg.data[1] ),
    .Y(_0400_));
 sky130_fd_sc_hd__o21ai_1 _0824_ (.A1(_0400_),
 ...
 sky130_fd_sc_hd__nand2_4 _0826_ (.A(_0320_),
    .B(_0321_),
    .Y(_0401_));
 sky130_fd_sc_hd__and2_1 _0827_ (.A(_0397_),
    .B(_0401_),
    .X(_0402_));
 ...
 sky130_fd_sc_hd__clkbuf_1 _0846_ (.A(_0416_),
    .X(net169));
 sky130_fd_sc_hd__or2_1 _0847_ (.A(net171),
    .B(net172),
    .X(_0417_));
 ...
 sky130_fd_sc_hd__clkbuf_4 _0851_ (.A(net34),
    .X(_0419_));
 sky130_fd_sc_hd__clkbuf_4 _0852_ (.A(_0419_),
    .X(_0420_));
 ...
 sky130_fd_sc_hd__a21oi_1 _0867_ (.A1(_0290_),
    ...
    .B1(_0434_),
    .Y(_0435_));
 sky130_fd_sc_hd__or2_1 _0868_ (.A(_0401_),
    .B(_0314_),
    .X(_0436_));
 ...
 sky130_fd_sc_hd__nor2_1 _0889_ (.A(net67),
    .B(net34),
    .Y(_0452_));
 sky130_fd_sc_hd__nor2_2 _0890_ (.A(net67),
    .B(_0402_),
    .Y(_0453_));
 sky130_fd_sc_hd__a21oi_1 _0891_ (.A1(_0314_),
    ...
    .B1(_0453_),
    .Y(_0454_));
 sky130_fd_sc_hd__a31o_1 _0892_ (.A1(\cpu.state.ibus_cyc ),
    .A2(_0314_),
    .A3(_0452_),
    .B1(_0454_),
    .X(_0010_));
 ...
 sky130_fd_sc_hd__mux2_1 _0967_ (.A0(\cpu.immdec.gen_immdec_w_eq_1.imm11_7[1] ),
    ...
    .S(_0419_),
    .X(_0511_));
 sky130_fd_sc_hd__o21a_1 _0968_ (.A1(net193),
    .A2(_0457_),
    .B1(_0447_),
    .X(_0512_));
 ...
 sky130_fd_sc_hd__and3b_1 _0971_ (.A_N(_0457_),
    ...
    .C(_0447_),
    .X(_0514_));
 sky130_fd_sc_hd__clkbuf_4 _0972_ (.A(_0419_),
    .X(_0515_));
 ...
 sky130_fd_sc_hd__a22o_1 _1015_ (.A1(net155),
    ...
    .B2(net156),
    .X(_0060_));
 sky130_fd_sc_hd__a22o_1 _1016_ (.A1(net156),
    .A2(_0526_),
    .B1(_0527_),
    .B2(net157),
    .X(_0061_));
 ...
 sky130_fd_sc_hd__clkbuf_1 _1039_ (.A(_0538_),
    .X(_0073_));
 sky130_fd_sc_hd__buf_4 _1040_ (.A(_0324_),
    .X(_0539_));
 ...
 sky130_fd_sc_hd__clkbuf_1 _1149_ (.A(_0613_),
    .X(_0108_));
 sky130_fd_sc_hd__clkbuf_4 _1150_ (.A(net34),
    .X(_0614_));
 ...
 sky130_fd_sc_hd__a21bo_1 _1198_ (.A1(_0420_),
    ...
    .B1_N(_0636_),
    .X(_0649_));
 sky130_fd_sc_hd__o22a_1 _1199_ (.A1(\cpu.immdec.gen_immdec_w_eq_1.imm30_25[5] ),
    .A2(_0636_),
    .B1(_0648_),
    .B2(_0649_),
    .X(_0122_));
 ...
 sky130_fd_sc_hd__clkbuf_1 _1265_ (.A(_0210_),
    .X(_0149_));
 sky130_fd_sc_hd__clkbuf_4 _1266_ (.A(_0572_),
    .X(_0211_));
 ...
 sky130_fd_sc_hd__dfxtp_1 _1348_ (.CLK(clk),
    .D(_0014_),
    .Q(net172));
 sky130_fd_sc_hd__dfxtp_1 _1349_ (.CLK(clk),
    .D(_0015_),
    .Q(net173));
 ...
 sky130_fd_sc_hd__dfxtp_1 _1352_ (.CLK(clk),
    .D(_0018_),
    .Q(\rf_ram_if.wen1_r ));
 sky130_fd_sc_hd__dfxtp_1 _1353_ (.CLK(clk),
    .D(_0019_),
 ...
 sky130_fd_sc_hd__dfxtp_1 _1368_ (.CLK(clk),
    .D(_0001_),
    .Q(\cpu.alu.add_cy_r ));
 sky130_fd_sc_hd__dfxtp_1 _1369_ (.CLK(clk),
    .D(_0034_),
    .Q(net137));
 ...
 sky130_fd_sc_hd__dfxtp_1 _1470_ (.CLK(clk),
    .D(_0132_),
    .Q(\cpu.bne_or_bge ));
 ...
 sky130_fd_sc_hd__dfxtp_1 _1479_ (.CLK(clk),
    .D(_0141_),
    .Q(net111));
 sky130_fd_sc_hd__dfxtp_1 _1480_ (.CLK(clk),
    .D(_0142_),
    .Q(net122));
 ...
 sky130_fd_sc_hd__dfxtp_1 _1497_ (.CLK(clk),
    .D(_0159_),
    .Q(net110));
 sky130_fd_sc_hd__dfxtp_1 _1498_ (.CLK(clk),
    .D(_0160_),
    .Q(net112));
 ...
 sky130_fd_sc_hd__clkbuf_1 input13 (.A(i_dbus_rdt[1]),
    .X(net13));
 sky130_fd_sc_hd__clkbuf_1 input14 (.A(i_dbus_rdt[20]),
    .X(net14));
 ...
 sky130_fd_sc_hd__buf_1 input42 (.A(i_ibus_rdt[17]),
    .X(net42));
 sky130_fd_sc_hd__buf_1 input43 (.A(i_ibus_rdt[18]),
    .X(net43));
 ...
 sky130_fd_sc_hd__buf_1 input66 (.A(i_rdata[1]),
    .X(net66));
 sky130_fd_sc_hd__buf_2 input67 (.A(i_rst),
    .X(net67));
